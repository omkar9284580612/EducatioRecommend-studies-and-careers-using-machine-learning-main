...
def Recommendations(gender: str, part_time_job: bool, absence_days: int, extracurricular_activities: bool,
                    weekly_self_study_hours: int, math_score: int, history_score: int, physics_score: int,
                    chemistry_score: int, biology_score: int, english_score: int, geography_score: int,
                    total_score: float, average_score: float) -> list:
    try:
